...
function StatCard({
  ...
  return (
    <div
      ref={cardRef}
      className="group relative overflow-hidden rounded-3xl glass-strong border border-brand/10 p-7 shadow-elegant transition-all duration-300 hover:shadow-glow"
    >
  ...
  return (
    <section id="about" ref={sectionRef} className="relative py-28 overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div
          ref={contentRef}
          className="mx-auto mb-20 max-w-4xl rounded-3xl glass-strong border border-brand/10 p-8 shadow-elegant md:p-12"
        >
